package org.prabhu.rcp.viewer.table.dialogs;
...
public class AddEmployeeDialog extends TitleAreaDialog {
	...
	protected Control createContents(Composite parent) {
		...
		setMessage("Please enter the data of the new Employee",
	...
	protected Control createDialogArea(Composite parent) {
		...
		button1.setText("Is Emp permanent?");
		...
		button.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				if (text1.getText().length() != 0
					...
					emp = new Employee(text1.getText(), text2.getText(),
